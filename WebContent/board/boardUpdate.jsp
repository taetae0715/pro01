...
<head>
   ...
   .vs, .img_box { height:50vh; margin-top: -45px; }
    ...
    .indata { display:inline-block; width:700px; height:24px; line-height:24px; padding:10px; }
...
%>							
								...
								<tr>
									<td colspan="2">
										<a href="boardDetail.jsp?bno=<%=bno %>" class="btn btn-primary">이전</a>
										<input type="submit" value="수정" class="btn btn-cancle"> &nbsp; &nbsp; &nbsp; &nbsp;
										<a href="prcenter.jsp#page4" class="btn btn-primary">목록으로</a>
									</td>
								</tr>
<%
						}

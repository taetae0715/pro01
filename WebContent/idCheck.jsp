...
%>
					<h3>이미 사용 중인 아이디입니다.<br>다시 입력하시기 바랍니다.</h3>
					<input type="hidden" id="ps" name="ps" value="no">
					<input type="hidden" id="msg" name="msg" value="이미 사용 중인 아이디입니다. 다시 입력하시기 바랍니다.">
<%
...
%>
					...
					<input type="hidden" id="msg" name="msg" value="사용 가능한 아이디입니다.">
<% 				} %>
